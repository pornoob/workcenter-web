 ...
 */
@Entity
@Table(name = "mir_severidad", schema = "")
@NamedQueries(
        @NamedQuery(name = "MirSeveridad.findAll", query = "SELECT s FROM MirSeveridad s ORDER BY s.id ASC")
)
public class MirSeveridad implements Serializable {
    private Integer id;
    ...
    public boolean equals(Object o) {
        ...
        MirSeveridad that = (MirSeveridad) o;
