...
public abstract class Equipo_ {
	...
	public static volatile SetAttribute<Equipo, MmeMantencionTracto> mantenimientos;
	...
	public static volatile SetAttribute<Equipo, MmeMantencionMaquina> mantenimientosMaquina;
