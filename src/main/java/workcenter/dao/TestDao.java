...
public class TestDao {
    private final String bonoStr = "Hrs. Extras";
    private final String periodo = "01-03-2016";
    private final String empleador = "76049643-K";
...
{ "18369636","0" }
    ...
    public void cargar() {
        ...
        q = em.createNativeQuery("insert into maestroGuiasBonosDescuentos (idMaestroGuia, descripcion, imponible, bono) " +
                ...
                "from maestroGuias " +
                "where " +
                "rutEmpleador = :empleador " +
                "and fechaLiquidacion = STR_TO_DATE(:periodo, '%d-%m-%Y') " +
        ...
        q.setParameter("empleador", empleador);
        ...
        System.out.println("Resultados: "+idBonoRemuneracion.size());
        
        for (int i = 0; i < montos.size(); i++) {
            String monto = montos.get(i).trim();
